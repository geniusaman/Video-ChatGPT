...
with gr.Blocks(css="#chatbot {overflow:auto; height:500px;}") as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Row():
                example_videos = gr.Dataset(components=[input_video_path], samples=[['images/playing_guitar.mp4'],
                                                                                    ['images/yoga.mp4'],
    ...
    caption.click(inference, [input_video_path, input_tag],
                  [model_tag_output, user_tag_output, image_caption_output, dense_caption_output, chat_video, loadinglabel])

    chat_video.click(bot.init_agent, [image_caption_output, dense_caption_output, model_tag_output],
                     [input_raws, chatbot])
...
demo.launch(server_name="0.0.0.0", share=True)  # Assuming demo is your Gradio interface
